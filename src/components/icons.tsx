// lucide-react v1 dropped brand/logo icons (GitHub, LinkedIn, etc.) to keep the
// package lean — see https://lucide.dev/guide/react/migration. These two are
// small hand-rolled replacements sized to drop in wherever a lucide icon is used.
